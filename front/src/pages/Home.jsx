...
export default function Home(){
    return (
        <div className="home_page">
            <Header />
            <h1 className="headSlogan">Terminés les rendez-vous interminables avec le banquier. <b className="test">Conso.</b> fait tout pour vous</h1>
            <SimulationButton text='Effectuer ma simulation' to="/loan_application" />
